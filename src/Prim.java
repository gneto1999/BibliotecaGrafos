...
public class Prim {
    public static void primMst(List<List<Edge>> adjacencyList, int numVertices) throws IOException {
    ...
    public static void primMst(int [][] adjacencyMatrix, int numVertices) throws IOException {
        int [] key = new int[numVertices];
        Integer [] parent = new Integer[numVertices];
        boolean [] visited = new boolean[numVertices];
